...
CREATE TABLE ChitietKhoThanhLy (
	...
	VANDE INT,--NÓ XEM XÉT SÁCH ĐÓ HƯ 2 HAY K CÒN NHU CẦU SỬ DỤNG 1.. NẾU CẦN
	PRIMARY KEY (MASACHKHO, MACUONSACH),
	TINHTRANG INT, -- 0 CHƯA THANH LÍ, 1 ĐÃ THANH LÍ
	FOREIGN KEY (MACUONSACH) REFERENCES CUONSACH(MACUONSACH),
...
--DROP CONSTRAINT UQ_ChitietKhoThanhLy_MaCuonSach UNIQUE (MaCuonSach);
