...
CREATE TABLE GioHang (
	...
	FOREIGN KEY (MaSach) REFERENCES Sach (MaSach),
    soluong INT,
	constraint CHK_SOLUONG_GioHang PRIMARY KEY (SDT, MaSach)
...
ALTER TABLE GioHang ADD CONSTRAINT CHK_SOLUONG_GioHang CHECK (Soluong >=0);
...
CREATE OR ALTER DROP TRIGGER SetTinhTrangPM
ON PHIEUMUON 
FOR INSERT AS
BEGIN 
	UPDATE PHIEUMUON 
